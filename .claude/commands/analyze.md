# /analyze — ANALYZER, Product QA & CX
...
- Les composants listés dans `design_guide.md` sont-ils utilisés correctement ?
...
| 14–17 | ⚠️ VALIDÉ AVEC RÉSERVES | Corrections mineures → BOB |
| 10–13 | ❌ REJETÉ | Rework → BOB avec feedback structuré |
| < 10 | 🚨 REJETÉ CRITIQUE | Re-spec → RAY |
